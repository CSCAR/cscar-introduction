...
## Statistical Modeling {data-background='img/priorLikePosterior.png'}
...
## Programming Expertise {data-background='img/Rlogo.svg'}
...
## Other Assistance {data-background='img/plotly_scatter.png'}
...
<div style="text-align:center; font-size: 150%">Hands on programming</div>
<div style="text-align: center; font-size: 150%">Data Science Skill Series</div>
...
##  {data-transition="zoom" data-autoslide="5000" }
...
## {data-background="img/cscar84.png"}